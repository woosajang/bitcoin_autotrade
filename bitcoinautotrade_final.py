            ...
            for c in range(0, len(coin_list)):
                ...
                if current_price > ma5 : #상승 Transition
                    if rising_transition_list.count(coin_list[c]) < 500 and coin_list[c] not in start:
                        ...
                        max_price = target_price_orgin * 1.0 + last_price
                ...
                # print(coin_list[c], target_price_short < current_price ,coin_list[c] not in i_list_short ,krw_buy > 5000 \
                #         , last_price / open_price < limit , current_price < max_price , bbk.count(coin_list[c]) > 5\
                #         , target_price_orgin /open_price < 0.1 )
